...
import { ChainAddressKey, ETHEREUM_MERKL_XYZ_CONTRACT } from '@suite-common/earn-stablecoin-api';
...
export const YieldClaim = ({ account }: YieldClaimProps) => {
    ...
    const isClaimSupported = !!network?.chainId && !!ETHEREUM_MERKL_XYZ_CONTRACT[network.chainId];
