...
// `local` falls back to the bundled default until init() may override it from a newer source.
let local: FirmwareReleaseConfig = getOnlyLocalFirmwareReleaseConfig().config;
let releases:
...
export const init = async (
    ...
    local = getOnlyLocalFirmwareReleaseConfig().config;
