...
// Simply replaces a substring in hex-encoded data
const replaceInHex = (str: string, searchValue: string, replaceValue: string) =>
    str.replace(
...
export const verifyAuthenticityProofFixtures: Fixture[] = [
    ...
    },
    {
        ...
        result: {
            valid: true,
            rootPubKey: T3W1rootPubKeyTropic,
    ...
    },
    {
        ...
        result: {
            valid: true,
            rootPubKey: T3W1rootPubKeyMLDSA,
        },
    },
